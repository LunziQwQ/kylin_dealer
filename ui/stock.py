...
class Ui_StockWindow(object):
    ...
    def retranslateUi(self, StockWindow):
        ...
        self.addCargoTypeBtn.setText(_translate("StockWindow", "添加种类"))
